...
public class Wyniki {
    ...
    private Long id_l;
    private Long id_c;
    private Text opis_wyniku;

    public Wyniki(){
    }
    public Wyniki (Long id_wyniku, Long id_p, Long id_b, Long id_l, Long id_c, Text opis_wyniku){
    ...
    public Text getOpis_wyniku() {
        return opis_wyniku;
    }

    public void setOpis_wyniku(Text opis_wyniku) {
        this.opis_wyniku = opis_wyniku;
    }
